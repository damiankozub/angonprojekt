...
class WP_bootstrap_4_walker_nav_menu extends Walker_Nav_menu
{
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        $output .= "<li id='nav-item-".$item->ID."' class='nav-item $active_class $dropdown_class " .  implode(" ", $item->classes) . "'>";
    ...
    function start_lvl( &$output, $depth=0, $args = array() ){
        ...
        $output .= "<div class='dropdown-menu $submenu depth_$depth'><ul class='container'>";
    }
